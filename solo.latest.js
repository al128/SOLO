/* SOLO Web/canvas utils MIT License | github.com/al128/SOLO | therook.co.uk | belowthestorm.co.uk */
...
String.prototype.queryString = function() { key = this.replace(/[*+?^$.\[\]{}()|\\\/]/g, "\\$&"); var match = location.search.match(new RegExp("[?&]"+key+"=([^&]+)(&|$)"));  return match && decodeURIComponent(match[1].replace(/\+/g, " ")); }
...
Math.boxCollision = function(box1, box2) {
